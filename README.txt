Due to privacy reasons we were not able to share real data in this submission.
...
# Scripts
First run from process_friends from scripts/. 
...
be moved to frontend visualization = visualisation/src/inputs/ folder and 
a reference in visualization/src/DataManager.js should be changed to the new file.
How to run edited visualisation code is explained in readme in the visualisation/ folder.
